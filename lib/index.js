...
module.exports = {
    ...
    getBabel: function (options) {
        ...
        function moduleName() {
            var name = 'babel-runtime';
            var moduleName = path.join(__dirname,'../node_modules',name);
            if(!fs.existsSync(moduleName)){
                moduleName = path.join(__dirname,'../node_modules/babel-plugin-transform-runtime/node_modules',name);
                if(!fs.existsSync(moduleName)){
                    moduleName = name;
                }
            }
    ...
    getPlugins: function (defaultWebpackOption, options) {
        ...
        if (options.isCommon === true) {
            ...
            var filename = basePath + '/common.js';
            if(options.isOneDir && options.isCom){
    ...
    getLoader: function (options) {
        ...
        var css = 'css-loader?-autoprefixer';
        return [
            {
                test: /\.less$/,
                use: getUse([css, 'less-loader', postcss])
            }, {
                test: /\.scss$/,
                use: getUse([css, 'sass-loader', postcss])
            }, {
                test: /\.css$/,
                use: getUse([css, postcss])
            },
            {
                test: /\.(jst|ejs)(\.html)?$/,
    ...
    hotFile: function (options, file) {
        if (options.isHot) {
            ...
            if(!fs.existsSync(clientPath)){
                clientPath = path.join(__dirname,'../../webpack-hot-middleware/client.js');
            }
            if (!fs.existsSync(clientPath)) {
                clientPath = path.join(__dirname, '../node_modules/webpack-hot-middleware/client.js');
            }
